...
struct EmojiPickerSnapshotTests {
    ...
    @Test func categoryGrid() {
        ...
        assertSnapshot(of: snapshotImage(view, width: 400, height: 460), as: snapshotImageStrategy)
    }
    ...
    @Test func categoryGridDark() {
        let view = EmojiPickerView(viewModel: Fixtures.emojiPickerViewModel())
        assertSnapshot(of: snapshotImage(view, width: 400, height: 460, dark: true), as: snapshotImageStrategy)
    }
}
